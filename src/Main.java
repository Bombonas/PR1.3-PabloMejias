    ...
    while (running) {
      ...
      try {
        switch (opcio) {
          ...
          case 2: PR131mainEscriu.main(args); break;
          case 3: PR131mainLlegeix.main(args); break;
          case 4: PR132main.main(args); break;
          case 5: PR134mainRandomAcces.main(args);break;
          // Adapta aquí les altres classes de l’exercici (PR122cat…)
